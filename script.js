...
//biar keren 
const icon = document.getElementById("icon-searching");
icon.addEventListener("click",function(){
    var input =document.getElementById("filtering");
    icon.classList.toggle("berputar")
    input.classList.toggle("width-tambah")
